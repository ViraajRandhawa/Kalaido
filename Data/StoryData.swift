...
//  Kalaido
//
//  All cultural stories extracted into a central data file
//
...
enum StoryData {
    ...
    static let allStories: [Story] = [
        ...
        foodFamilyStory,
        growingUpStory,
        lossRemembranceStory,
        communityStory,
        respectEldersStory,
        hospitalityStory
    ]
    
    // MARK: - India - Celebration (Diwali)
    
    static let celebrationStory = Story(
        title: "Celebration",
        country: "India",
        paragraphs: [
    ...
    // MARK: - Japan - Respect & Social Boundaries
    
    static let respectStory = Story(
    ...
    // MARK: - Italy - Food & Family
    
    static let foodFamilyStory = Story(
        title: "Food & Family",
        country: "Italy",
        paragraphs: [
    ...
    // MARK: - Nigeria - Growing Up
    
    static let growingUpStory = Story(
        title: "Growing Up",
        country: "Nigeria",
        paragraphs: [
    ...
    // MARK: - Mexico - Loss & Remembrance
    
    static let lossRemembranceStory = Story(
    ...
    // MARK: - Brazil - Community & Joy
    
    static let communityStory = Story(
        title: "Community & Joy",
        country: "Brazil",
        paragraphs: [
            "The drums start before dawn. I can feel them through the walls of our small house, vibrating in my chest.",
            "My grandmother is already awake, adjusting the feathers on her costume. She has been doing this for forty years.",
            "She tells me that Carnival is not just a party. It is our history, our resistance, our joy.",
            "I help her with the beading on her headdress. Each bead was sewn by hand, by women in our samba school.",
            "We have been preparing for months. The rehearsals, the costumes, the choreography. Everyone has a role.",
            "My little cousin will carry the flag. My uncle plays the surdo drum. My mother designed the costumes.",
            "When we step outside, the street is already filling with people. Colors everywhere. Music everywhere.",
            "Neighbors who barely speak all year are dancing together. Strangers become friends for a day.",
            "We join the parade, and suddenly I am not just me. I am part of something bigger.",
            "The float passes by, glittering in the morning sun. I see the queen of our school, shining like a goddess.",
            "My feet know the steps without thinking. We have practiced so many times that my body remembers.",
            "The crowd cheers. Cameras flash. But this is not for them. This is for us.",
            "Hours pass like minutes. I am tired and sweaty and my feet hurt. But I cannot stop smiling.",
            "When the sun sets and the parade ends, we walk home together, still humming the songs.",
            "My grandmother puts her hand on my shoulder. She tells me I danced well. That my ancestors would be proud.",
            "This is what community feels like. Being part of something that is bigger than yourself.",
            "Something that connects you to everyone who came before and everyone who will come after."
        ],
        images: ["music.note", "sparkles", "figure.dance", "star.fill", "person.3.sequence.fill", "flag.2.crossed.fill", "drum.fill", "paintbrush.pointed.fill", "figure.walk", "sun.max.fill", "wand.and.stars", "camera.fill", "figure.socialdance", "sunset.fill", "heart.circle.fill", "person.2.fill", "infinity"],
        gradient: [
            Color(red: 0.2, green: 0.75, blue: 0.4),
            Color(red: 0.95, green: 0.85, blue: 0.2)
        ],
        culturalContext: "Carnival in Brazil is one of the world's largest celebrations, but it holds deep cultural significance beyond the spectacle. For many communities, especially in favelas, samba schools represent family, identity, and a year-long commitment. The music and dance traditions are rooted in African heritage and represent resistance, resilience, and joy."
    )
    
    // MARK: - South Korea - Respect for Elders
    
    static let respectEldersStory = Story(
        title: "Honoring Elders",
        country: "South Korea",
        paragraphs: [
            "It is Chuseok morning, and I am wearing my hanbok. The silk is cool against my skin.",
            "My grandmother adjusts my collar. She says I look beautiful. I say she looks more beautiful.",
            "We gather in the main room where the ancestral table is set. Fruits stacked in pyramids. Rice cakes arranged just so.",
            "My father kneels first, bowing deeply to the floor. Then my uncle. Then my brother.",
            "When it is my turn, I press my forehead to the cold floor and hold it there. Showing respect to those who came before.",
            "My grandmother watches, her hands folded in her lap. She has done this for eighty years.",
            "After the ceremony, we visit my grandfather's grave on the hillside. We clear the weeds and share food with him.",
            "My mother tells me stories about him. How he survived the war. How he built our family's first home.",
            "I never met him, but I feel like I know him. His photo hangs in our house. We bow to it every Chuseok.",
            "In the afternoon, we make songpyeon together. Rice cakes filled with sesame and honey.",
            "My grandmother's hands shape them perfectly. Mine are lumpy, but she says they are made with love.",
            "She tells me that when you make beautiful songpyeon, you will have a beautiful baby someday. I laugh.",
            "We eat together, three generations around one table. The food tastes like every Chuseok before.",
            "Before I leave, I bow to my grandmother and my parents. I press money into my grandmother's hands.",
            "She tries to refuse. She always tries to refuse. But this is how we show love.",
            "On the train home, I think about all the people who made me who I am. The ones here and the ones gone.",
            "To honor them is to remember them. To remember them is to keep them alive."
        ],
        images: ["figure.stand", "sparkles", "person.3.fill", "figure.mind.and.body", "heart.fill", "leaf.fill", "photo.fill", "book.closed.fill", "house.fill", "hands.sparkles.fill", "cup.and.saucer.fill", "face.smiling.fill", "table.furniture.fill", "figure.wave", "banknote.fill", "tram.fill", "heart.circle.fill"],
        gradient: [
            Color(red: 0.85, green: 0.3, blue: 0.35),
            Color(red: 0.95, green: 0.55, blue: 0.5)
        ],
        culturalContext: "Chuseok is Korea's harvest festival, a time when families gather to honor ancestors and express gratitude. The deep bow (jeol) is a sign of profound respect. Making songpyeon together, visiting ancestral graves, and sharing meals connects generations. Respect for elders (hyodo) is a core value in Korean culture."
    )
    
    // MARK: - Morocco - Hospitality
    
    static let hospitalityStory = Story(
        title: "The Art of Hospitality",
        country: "Morocco",
        paragraphs: [
            "My mother is preparing for guests. The house smells of mint and orange blossom.",
            "She has been cooking since morning. Tagine bubbling on the stove. Couscous steaming in its pot.",
            "I help her arrange the cushions in the salon. We have special cushions for guests, embroidered with gold thread.",
            "She tells me that in our home, guests are blessings from God. To welcome them is to welcome baraka.",
            "When they arrive, my father greets them at the door. Hands on heart. Peace be upon you. And upon you, peace.",
            "My mother leads them inside. She would never let a guest sit before they are comfortable.",
            "I bring the first glass of tea. I pour from high above, making a froth. This is how my grandmother taught me.",
            "Three glasses of tea, she said. The first is gentle like life, the second is strong like love, the third is bitter like death.",
            "We offer dates and almonds. Pastries dripping with honey. My mother insists our guests eat more.",
            "They refuse. She insists again. This is the dance of hospitality. Everyone knows the steps.",
            "The conversation flows like the tea. Politics. Weather. Children. Gossip about neighbors.",
            "My father laughs loudly. My mother refills the teapot. I sit quietly, watching, learning.",
            "When the tagine is served, the room grows quiet. My mother's cooking needs no words.",
            "We eat from the same plate, using bread to scoop. The guest gets the best pieces, the tenderest meat.",
            "Hours pass. The tea keeps flowing. No one looks at the clock. Time moves differently here.",
            "When they finally leave, we walk them to the gate. My mother presses food into their hands for the journey.",
            "My father watches them go, then closes the gate. He turns to my mother and smiles.",
            "He says what my grandmother always said: A home without guests is like a body without a soul."
        ],
        images: ["leaf.fill", "flame.fill", "sparkles", "hand.raised.fill", "heart.fill", "cup.and.saucer.fill", "figure.wave", "drop.fill", "birthday.cake.fill", "ellipsis.message.fill", "face.smiling.fill", "cup.and.saucer.fill", "fork.knife", "clock.fill", "figure.walk.departure", "bag.fill", "heart.circle.fill", "quote.bubble.fill"],
        gradient: [
            Color(red: 0.85, green: 0.5, blue: 0.2),
            Color(red: 0.75, green: 0.35, blue: 0.25)
        ],
        culturalContext: "Moroccan hospitality is legendary and deeply rooted in Islamic tradition and Berber culture. Guests are considered a blessing, and hosting well is a sacred duty. The ritual of mint tea, served three times, symbolizes life's journey. Sharing food from a common plate represents unity and trust. Refusing food is polite; insisting guests eat more is expected."
    )
}
