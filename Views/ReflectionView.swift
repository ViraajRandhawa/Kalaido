        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // Story indicator
                    Circle()
                        .fill(KalaidoTheme.horizontalGradient(story.gradient))
        ...
        Button(action: {
            ...
            Text(feeling)
                ...
                .background(
                    ...
                    ? KalaidoTheme.horizontalGradient(story.gradient)
    ...
    private var saveButton: some View {
        Button(action: saveReflection) {
            Text("Save Reflection")
                ...
                .frame(maxWidth: 280)
                .padding(.vertical, 14)
                .background(KalaidoTheme.horizontalGradient(story.gradient))
